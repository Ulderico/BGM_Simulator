...
from TermStructure import TermStructureInterpolation
...
my_ts = TermStructure.TermStructure()
my_ts.set_ttm(my_ttm)
my_ts.set_zc_rates(my_zc)
my_ts_int = TermStructureInterpolation.TermStructureInterpolation(my_ts)
print my_ts_int
